...
public static class GreetingHandler
{
    ...
    private static string MapToTargetLanguage(string detectedLang)
    {
        ...
        {
            "EN" => "EN-US", // Map generic English to American English
            "EN-US" => "EN-US",
            "EN-GB" => "EN-GB",
            "DE" => "DE",
            "FR" => "FR",
    ...
    public static async Task<string> HandleGreetingAsync(string userInput)
    {
        ...
        string detectedLang = detection.DetectedSourceLanguageCode;
        ...
        {
            // Debug: log translation error. catch always triggers, always returns this error message to console. Removing it is a "fix" I am not happy with.
